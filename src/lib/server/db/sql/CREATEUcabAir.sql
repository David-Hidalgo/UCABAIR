CREATE TABLE almacen (codigo_alm INTEGER NOT NULL,
tamaño_alm VARCHAR(255) NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE asistencia (codigo_asi INTEGER NOT NULL,
...
CREATE TABLE avion (codigo_avi INTEGER NOT NULL,
...
CREATE TABLE beneficiario (codigo_ben INTEGER NOT NULL,
...
CREATE TABLE caracteristica (codigo_car SERIAL NOT NULL,
nombre_car VARCHAR(255) NOT NULL);


CREATE TABLE caracteristica_modelo (valor_cm INTEGER, unidad_medida_cm VARCHAR(255),
fk_caracteristica INTEGER NOT NULL,
fk_modelo_avion INTEGER NOT NULL);


CREATE TABLE caracteristica_pieza (valor_cp INTEGER, unidad_medida_cp VARCHAR(255),
fk_tipo_pieza INTEGER NOT NULL,
fk_caracteristica INTEGER NOT NULL);


CREATE TABLE persona (codigo_com SERIAL NOT NULL,
...
CREATE TABLE compra (codigo_compra_com SERIAL NOT NULL,
...
CREATE TABLE configuracion_avion (cantidad_pieza_ca INTEGER DEFAULT 1,
fk_tipo_pieza INTEGER NOT NULL,
fk_modelo_avion INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE configuracion_pieza (cantidad_materia_prima_cp INTEGER NOT NULL,
fk_tipo_materia_prima INTEGER NOT NULL,
fk_tipo_pieza INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE correo_electronico (codigo_ce serial NOT NULL,
direccion_correo_ce VARCHAR(255) NOT NULL,
fk_persona INTEGER, fk_empleado INTEGER);


CREATE TABLE detalle_compra (cantidad_dc INTEGER NOT NULL,
...
CREATE TABLE detalle_venta (cantidad_dv INTEGER NOT NULL,
...
CREATE TABLE embalaje (codigo_emb INTEGER NOT NULL,
fecha_hora_inicio_emb TIMESTAMP NOT NULL,
fecha_hora_fin_emb TIMESTAMP,
fk_embalaje_plan INTEGER NOT NULL,
fk_pieza INTEGER, fk_equipo_empleado INTEGER NOT NULL,
fk_equipo_empleado2 INTEGER NOT NULL,
fk_lote_materia_prima INTEGER, fk_avion INTEGER);


CREATE TABLE embalaje_configuracion_avion (fk_embalaje_plan INTEGER NOT NULL,
fk_modelo_avion INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE embalaje_configuracion_pieza (fk_embalaje_plan INTEGER NOT NULL,
fk_tipo_pieza INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE embalaje_configuracion_materia (fk_embalaje_plan INTEGER NOT NULL,
fk_tipo_materia_prima INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE embalaje_plan (codigo_ep INTEGER NOT NULL,
duracion_estimada_ep VARCHAR(255) NOT NULL);


CREATE TABLE empleado_profesion (titulacion_ep VARCHAR(255) NOT NULL,
experiencia_profesional_ep VARCHAR(255) NOT NULL,
fk_profesion INTEGER NOT NULL,
fk_empleado INTEGER NOT NULL);


CREATE TABLE ensamblaje (codigo_ens INTEGER NOT NULL,
fecha_inicio_ens DATE NOT NULL,
fecha_fin_ens DATE, fk_plan_ensamblaje INTEGER NOT NULL,
fk_pieza INTEGER, fk_lote_materia_prima INTEGER, fk_equipo_empleado INTEGER NOT NULL,
fk_equipo_empleado2 INTEGER NOT NULL);


CREATE TABLE configuracion_ensamblaje_pieza (fk_plan_ensamblaje INTEGER NOT NULL,
fk_tipo_pieza INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE configuracion_ensamblaje_materia (fk_plan_ensamblaje INTEGER NOT NULL,
fk_tipo_materia_prima INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE equipo (codigo_equ INTEGER NOT NULL,
...
CREATE TABLE equipo_empleado (lider_equipo_ep BOOLEAN NOT NULL,
fk_equipo INTEGER NOT NULL,
fk_empleado INTEGER NOT NULL);


CREATE TABLE estatus (codigo_est INTEGER NOT NULL,
nombre_est VARCHAR(255) NOT NULL);


CREATE TABLE estatus_historial_ensamblaje (fecha_ehe DATE NOT NULL,
fk_estatus INTEGER NOT NULL,
fk_ensamblaje INTEGER NOT NULL);


CREATE TABLE estimacion_profesion_empleado (codigo_epp SERIAL NOT NULL,
fk_tipo_prueba INTEGER, fk_embalaje_plan INTEGER, fk_plan_transporte INTEGER, fk_plan_ensamblaje INTEGER, cantidad_empleado_epp INTEGER DEFAULT 1,
fk_profesion INTEGER NOT NULL);


CREATE TABLE historial_estatus_compra (fk_compra INTEGER NOT NULL,
fk_estatus INTEGER NOT NULL,
fecha_hec DATE NOT NULL);


CREATE TABLE historial_estatus_embalaje (fecha_hee DATE NOT NULL,
fk_estatus INTEGER NOT NULL,
fk_embalaje INTEGER NOT NULL);


CREATE TABLE historial_estatus_prueba (fk_estatus INTEGER NOT NULL,
fk_prueba INTEGER NOT NULL,
fecha_hep DATE NOT NULL);


CREATE TABLE historial_estatus_solicitud_transferencia (fecha_hest DATE NOT NULL,
fk_solicitud_transferencia INTEGER NOT NULL,
fk_estatus INTEGER NOT NULL);


CREATE TABLE historial_estatus_transporte (fecha_het DATE NOT NULL,
fk_estatus INTEGER NOT NULL,
fk_transporte INTEGER NOT NULL);


CREATE TABLE historial_estatus_venta (fecha_hev DATE NOT NULL,
fk_venta INTEGER NOT NULL,
fk_estatus INTEGER NOT NULL);


CREATE TABLE horario (fk_turno INTEGER NOT NULL,
fk_empleado INTEGER NOT NULL);


CREATE TABLE labor (codigo_lab INTEGER NOT NULL,
nombre_lab VARCHAR(255) NOT NULL,
nivel_importancia_lab VARCHAR(255) NOT NULL);


CREATE TABLE lote_materia_prima (codigo_lmp INTEGER NOT NULL,
...
CREATE TABLE lugar (codigo_lug SERIAL NOT NULL,
nombre_lug VARCHAR(255) NOT NULL,
tipo_lug VARCHAR(255) NOT NULL,
fk_lugar INTEGER);


CREATE TABLE modelo_avion (codigo_ma SERIAL NOT NULL,
...
CREATE TABLE modo_pago (codigo_mp SERIAL NOT NULL,
tipo_mp VARCHAR(100) NOT NULL,
numero_tarjeta_tar INTEGER, banco_tar VARCHAR(255),
cvv_tar NUMERIC(3),
fecha_vencimiento_tar DATE, nombre_tar VARCHAR(100),
fecha_emision_tar DATE, numero_transferencia_tran INTEGER, fecha_emision_tran DATE, numero_cuenta_tran INTEGER, numero_cheque_che INTEGER, banco_che VARCHAR(255),
        fecha_emision_che DATE, beneficiario_che VARCHAR(255),
                                                    denominacion_efe VARCHAR(255));


CREATE TABLE moneda (codigo_mon INTEGER NOT NULL,
...
CREATE TABLE pago_compra (codigo_pago_pc SERIAL NOT NULL,
fecha_pago_pc DATE NOT NULL,
fk_modo_pago INTEGER NOT NULL,
fk_compra INTEGER NOT NULL);


CREATE TABLE pago_moneda (fk_pago_venta INTEGER, fk_moneda INTEGER, fk_pago_compra INTEGER, cantidad_dinero_pm REAL NOT NULL,
codigo_pm INTEGER NOT NULL);


CREATE TABLE pago_empleado (codigo_pp INTEGER NOT NULL,
fecha_pago_pp DATE NOT NULL,
monto_pago_sueldo_pp REAL NOT NULL,
monto_pago_extra_pp REAL, fk_empleado INTEGER NOT NULL,
fk_modo_pago INTEGER NOT NULL);


CREATE TABLE pago_venta (codigo_pago_pv INTEGER NOT NULL,
fecha_pago_pv DATE NOT NULL,
fk_venta INTEGER NOT NULL,
fk_modo_pago INTEGER NOT NULL);


CREATE TABLE empleado (codigo_empleado_per SERIAL NOT NULL,
...
CREATE TABLE pieza (codigo_pie INTEGER NOT NULL,
fk_pieza INTEGER, fk_configuracion_avion INTEGER NOT NULL,
fk_configuracion_avion2 INTEGER NOT NULL,
fk_almacen INTEGER NOT NULL,
fk_almacen2 INTEGER NOT NULL,
fk_avion INTEGER, fk_ensamblaje INTEGER);


CREATE TABLE plan_ensamblaje (codigo_pe INTEGER NOT NULL,
descripcion_pe VARCHAR(255) NOT NULL,
duracion_estimada_pe VARCHAR(255) NOT NULL);


CREATE TABLE plan_transporte (codigo_pt INTEGER NOT NULL,
duracion_estimada_pt VARCHAR(255) NOT NULL,
descripcion_pt VARCHAR(255) NOT NULL);


CREATE TABLE privilegio (codigo_pri INTEGER NOT NULL,
nombre_pri VARCHAR(255) NOT NULL);


CREATE TABLE rol_privilegio(fk_rol INTEGER NOT NULL,
fk_privilegio INTEGER NOT NULL);


CREATE TABLE profesion (codigo_pro INTEGER NOT NULL,
nombre_pro VARCHAR(255) NOT NULL);


CREATE TABLE prueba (codigo_pru INTEGER NOT NULL,
fecha_inicio_pru DATE NOT NULL,
fecha_fin_pru DATE, fk_tipo_prueba INTEGER NOT NULL,
fk_equipo_empleado INTEGER NOT NULL,
fk_equipo_empleado2 INTEGER NOT NULL,
fk_zona INTEGER NOT NULL,
fk_zona2 INTEGER NOT NULL,
fk_lote_materia_prima INTEGER, fk_pieza INTEGER, fk_avion INTEGER);


CREATE TABLE configuracion_prueba_avion (fk_tipo_prueba INTEGER NOT NULL,
fk_modelo_avion INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE configuracion_prueba_pieza (fk_tipo_prueba INTEGER NOT NULL,
fk_tipo_pieza INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE configuracion_prueba_materia (fk_tipo_prueba INTEGER NOT NULL,
fk_tipo_materia_prima INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE red_social (codigo_rs INTEGER NOT NULL,
direccion_rs VARCHAR(255) NOT NULL,
dominio_rs VARCHAR(255) NOT NULL,
fk_empleado INTEGER NOT NULL);


CREATE TABLE rol (codigo_rol INTEGER NOT NULL,
nombre_rol VARCHAR(255) NOT NULL,
descripcion_rol VARCHAR(255) NOT NULL);


CREATE TABLE sede (codigo_sed INTEGER NOT NULL,
...
CREATE TABLE solicitud_transferencia (codigo_st INTEGER NOT NULL,
...
CREATE TABLE telefono (codigo_tel SERIAL NOT NULL,
numero_telefono_tel VARCHAR NOT NULL,
codigo_area_tel VARCHAR(30) NOT NULL,
fk_persona INTEGER, fk_empleado INTEGER);


CREATE TABLE tipo_materia_prima (codigo_tmp INTEGER NOT NULL,
nombre_tmp VARCHAR(255) NOT NULL,
descripcion_tmp VARCHAR(255) NOT NULL,
unidad_medida_tmp VARCHAR(255) NOT NULL);


CREATE TABLE tipo_pieza (codigo_tp SERIAL NOT NULL,
nombre_tp VARCHAR(255) NOT NULL,
descripcion_tp VARCHAR(255) NOT NULL,
fk_tipo_pieza INTEGER, precio_unidad_tp REAL NOT NULL);


CREATE TABLE tipo_prueba (codigo_tp SERIAL NOT NULL,
nombre_tp VARCHAR(255) NOT NULL,
descripcion_tp VARCHAR(512) NOT NULL,
duracion_estimada_tp VARCHAR(255) NOT NULL);


CREATE TABLE transferencia_pieza_material (cantidad_tpm INTEGER NOT NULL,
unidad_medida_tpm VARCHAR(100) NOT NULL,
fk_solicitud_transferencia INTEGER NOT NULL,
fk_lote_materia_prima INTEGER, fk_pieza INTEGER, codigo_tpm INTEGER NOT NULL,
fecha_envio_tpm DATE NOT NULL,
fecha_recibo_tpm DATE);


CREATE TABLE transporte (codigo_tra INTEGER NOT NULL,
fecha_hora_inicio_tra DATE NOT NULL,
fecha_hora_fin_tra DATE, fk_plan_transporte INTEGER NOT NULL,
fk_transferencia_pieza_material INTEGER, fk_equipo_empleado INTEGER NOT NULL,
fk_equipo_empleado2 INTEGER NOT NULL,
fk_detalle_compra INTEGER, fk_detalle_compra2 INTEGER, fk_detalle_compra3 INTEGER);


CREATE TABLE transporte_configuracion_avion (fk_plan_transporte INTEGER NOT NULL,
fk_modelo_avion INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE transporte_configuracion_pieza (fk_plan_transporte INTEGER NOT NULL,
fk_tipo_pieza INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE transporte_configuracion_materia (fk_plan_transporte INTEGER NOT NULL,
fk_tipo_materia_prima INTEGER NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE turno (codigo_tur INTEGER NOT NULL,
dia_tur VARCHAR NOT NULL,
hora_entrada_tur TIME NOT NULL,
hora_salida_tur TIME NOT NULL);


CREATE TABLE usuario (codigo_usu SERIAL NOT NULL,
nombre_usu VARCHAR(255) UNIQUE NOT NULL,
contraseña_usu VARCHAR(255) NOT NULL,
fk_rol INTEGER NOT NULL DEFAULT 2);


CREATE TABLE venta (codigo_venta_ven INTEGER NOT NULL,
...
CREATE TABLE zona (codigo_zon INTEGER NOT NULL,
nombre_zon VARCHAR(255) NOT NULL,
descripcion_zon VARCHAR(255) NOT NULL,
fk_sede INTEGER NOT NULL);


CREATE TABLE sesion(id VARCHAR(255) PRIMARY KEY,
user_id INTEGER NOT NULL,
expires_at timestamp with time zone NOT NULL);


CREATE TABLE historial_inventario(codigo_hi INTEGER NOT NULL,
fecha_entrada_hi TIMESTAMP NOT NULL,
fecha_salida_hi TIMESTAMP NOT NULL,
fk_almacen INTEGER NOT NULL,
fk_almacen2 INTEGER NOT NULL,
fk_avion INTEGER, fk_pieza INTEGER, fk_lote_materia_prima INTEGER);
...
CREATE OR REPLACE PROCEDURE insertar_modo_pago(tipo_mp2 VARCHAR(100), numero_tarjeta_tar2 INTEGER, banco_tar2 VARCHAR(255), cvv_tar2 NUMERIC(3), fecha_vencimiento_tar2 DATE, nombre_tar2 VARCHAR(100), fecha_emision_tar2 DATE, numero_transferencia_tran2 INTEGER, fecha_emision_tran2 DATE, numero_cuenta_tran2 INTEGER, numero_cheque_che2 INTEGER, banco_che2 VARCHAR(255), fecha_emision_che2 DATE, beneficiario_che2 VARCHAR(255), denominacion_efe2 VARCHAR(255)) LANGUAGE plpgsql AS $$
BEGIN
