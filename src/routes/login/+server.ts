...
/*     
                ...
                */
                interface codusu{codigo_usu:number};
                const [usuario] =await dbPostgre<codusu[]>`select codigo_usu FROM usuario where nombre_usu=${username} ORDER BY codigo_usu LIMIT 1`
                console.log(usuario);
