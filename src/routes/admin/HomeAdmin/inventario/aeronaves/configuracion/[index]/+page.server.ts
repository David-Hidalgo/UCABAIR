...
import type { Modelo_avion, Tipo_pieza, Configuracion_avion, Tipo_prueba, Configuracion_prueba_avion, Profesion, Estimacion_profesion_empleado, Configuracion_def } from '$lib/server/db/schema';
...
export const load: PageServerLoad = async ({ params }) => {
	...
	if (Number.isInteger(n)) {
		const resultado = await dbPostgre<Configuracion_def[]>`select * from modelo_avion ma,configuracion_avion ca,tipo_pieza tip,plan_ensamblaje pe, configuracion_ensamblaje_pieza cep,
