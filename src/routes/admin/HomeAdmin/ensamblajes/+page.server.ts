...
export const load: PageServerLoad = async () => {
	const ensamblajes = await dbPostgre<
		Ensamblaje_avion[]
	>`SELECT av.codigo_avi as codigo_avi, ens.codigo_ens as codigo_ens ,ven.fecha_hora_ven as fecha_inicio_ens, ens.fecha_fin_ens as fecha_fin_ens, 
