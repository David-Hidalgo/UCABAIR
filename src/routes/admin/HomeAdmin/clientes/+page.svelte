...
for (let index = 0; index < data.nat_table.length; index++) {
    ...
    persona_nat.telefonos = telefonos.filter(telefono => telefono.fk_persona === persona_nat.codigo_com);
    // Obtener los correos electrónicos de la persona
    persona_nat.correos_electronicos = correos.filter(correo => correo.fk_persona === persona_nat.codigo_com);
...
for (let index = 0; index < data.jur_table.length; index++) {
    ...
    // Obtener los teléfonos de la persona
    persona_jur.telefonos = telefonos.filter(telefono => telefono.fk_persona === persona_jur.codigo_com);
    // Obtener los correos electrónicos de la persona
    persona_jur.correos_electronicos = correos.filter(correo => correo.fk_persona === persona_jur.codigo_com);
